...
@Module({
    imports: [
        ...
        MongooseModule.forRoot(
            `mongodb+srv://${process.env.CONFIG_MONGO_USERNAME}:${process.env.CONFIG_MONGO_PASSWORD}@cluster0.jil4did.mongodb.net/${process.env.CONFIG_MONGO_DB_NAME}?retryWrites=true&w=majority`,
            { autoIndex: true },
        ),
